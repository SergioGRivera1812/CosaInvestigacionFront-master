...
import LogoTwittor from "../../assets/png/icono tec.png";
import LogoWhiteTwittor from "../../assets/png/banner.png";
    ...
    <Col className="signin-signup__left" xs={6}>
      ...
      <div>
        ...
        <h2>
          ...
          Entérate de qué está hablando la comunidad del tec.
        </h2>
        <h2>
  ...
  return (
    <Col className="signin-signup__right" xs={6}>
      <div>
        ...
        <h3>Únete a Black Cat  hoy mimso.</h3>
        <Button
          variant="primary"
